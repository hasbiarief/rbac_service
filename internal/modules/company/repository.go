...
func (r *CompanyRepository) GetAll(limit, offset int, search string, isActive *bool) ([]*Company, error) {
	query := `
...
func (r *CompanyRepository) GetByCode(code string) (*Company, error) {
	query := `
		SELECT id, name, code, is_active, created_at, updated_at
		FROM companies
		WHERE code = $1
...
func (r *CompanyRepository) GetWithStats(id int64) (*CompanyWithStats, error) {
